...
export default function ButtonAppBar(props) {
  ...
  const options = ["Terms & Conditions", "Support", "About", "Login"];
  return (
          ...
          {width > 943 ? (
            <Box display="flex" justifyContent={`flex-end`}>
              ...
              >
                ...
                <Grid item xs={3}>
                  <Button color="inherit" href="https://www.byer.in/about">
                    <Typography
                      style={{ color: "#31BA2E" }}
                      sx={{ fontWeight: "bold" }}
                    >
                ...
                <Grid item xs={3}>
                  <Button color="inherit" href="/phone-auth">
                    <Typography
                      style={{ color: "#31BA2E" }}
                      sx={{ fontWeight: "bold" }}
                    >
